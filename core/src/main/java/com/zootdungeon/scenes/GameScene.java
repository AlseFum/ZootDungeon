...
import com.zootdungeon.sprites.DiscardedItemSprite;
import com.zootdungeon.sprites.HeroSprite;
import com.zootdungeon.sprites.ItemSprite;
import com.zootdungeon.tiles.CustomTilemap;
import com.zootdungeon.tiles.DungeonTerrainTilemap;
import com.zootdungeon.tiles.DungeonTileSheet;
import com.zootdungeon.tiles.DungeonTilemap;
import com.zootdungeon.tiles.DungeonWallsTilemap;
import com.zootdungeon.tiles.FogOfWar;
import com.zootdungeon.tiles.GridTileMap;
import com.zootdungeon.tiles.RaisedTerrainTilemap;
import com.zootdungeon.tiles.TerrainFeaturesTilemap;
import com.zootdungeon.tiles.WallBlockingTilemap;
...
import com.zootdungeon.ui.LootIndicator;
import com.zootdungeon.ui.MenuPane;
import com.zootdungeon.ui.QuickSlotButton;
import com.zootdungeon.ui.ResumeIndicator;
import com.zootdungeon.ui.RightClickMenu;
import com.zootdungeon.ui.StatusPane;
import com.zootdungeon.ui.StyledButton;
import com.zootdungeon.ui.Tag;
import com.zootdungeon.ui.TargetHealthIndicator;
import com.zootdungeon.ui.Toast;
import com.zootdungeon.ui.Toolbar;
import com.zootdungeon.ui.Window;
import com.zootdungeon.utils.GLog;
import com.zootdungeon.windows.WndBag;
import com.zootdungeon.windows.WndGame;
import com.zootdungeon.windows.WndHero;
import com.zootdungeon.windows.WndInfoCell;
import com.zootdungeon.windows.WndInfoItem;
...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		CDSettings.lastClass(Dungeon.hero.heroClass.ordinal());
		
		super.create();
		Camera.main.zoom( GameMath.gate(minZoom, defaultZoom + CDSettings.zoom(), maxZoom));
		Camera.main.edgeScroll.set(1);

		switch (CDSettings.cameraFollow()) {
		...
		status = new StatusPane( CDSettings.interfaceSize() > 0 );
		...
		if (CDSettings.intro()){
			...
			} else if (CDSettings.interfaceSize() == 0) {
				GameLog.wipe();
	...
	public static void layoutTags() {
		...
		boolean tagsOnLeft = CDSettings.flipTags();
		float tagWidth = Tag.SIZE + (tagsOnLeft ? insets.left : insets.right);
		float tagLeft = tagsOnLeft ? 0 : uiCamera.width - tagWidth;

		float y = CDSettings.interfaceSize() == 0 ? scene.toolbar.top()-2 : scene.status.top()-2;
		...
		if (tagsOnLeft && CDSettings.interfaceSize() > 0){
