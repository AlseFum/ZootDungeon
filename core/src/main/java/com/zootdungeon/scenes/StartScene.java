...
import com.zootdungeon.windows.WndGameInProgress;
	...
	public void create() {
		...
		StyledButton btnSort = new StyledButton(Chrome.Type.TOAST_TR, sortText, 6){
			...
			protected void onClick() {
				...
				if (CDSettings.gamesInProgressSort().equals("level")){
					CDSettings.gamesInProgressSort("last_played");
				} else {
					CDSettings.gamesInProgressSort("level");
				}
