 ...
 */
 ...
 package com.zootdungeon.levels.rooms.standard.entrance;

 import java.util.ArrayList;

 import com.zootdungeon.CDSettings;
 import com.zootdungeon.Dungeon;
 import com.zootdungeon.items.journal.GuidePage;
 ...
 public class EntranceRoom extends StandardRoom {
	 ...
	 public void paint(Level level ) {
		 ...
		 if (Dungeon.depth == 1 &&
				 (!Document.ADVENTURERS_GUIDE.isPageRead(Document.GUIDE_INTRO) || CDSettings.intro() )){
			 int pos;
			 do {
