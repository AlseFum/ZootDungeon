...
package com.zootdungeon.levels.painters;
...
import com.zootdungeon.levels.Patch;
import com.zootdungeon.levels.Terrain;
import com.zootdungeon.levels.rooms.Room;
import com.zootdungeon.levels.rooms.connection.ConnectionRoom;
			...
			for (Room n : r.connected.keySet()) {
				...
				if (d.type == Room.Door.Type.REGULAR){
					...
					if (r.isEntrance() || n.isEntrance()){
						if ((Dungeon.depth == 1 && CDSettings.intro())
