...
public abstract class EquipableMisc extends EquipableItem {
	...
	public boolean doEquip(final Hero hero) {
		...
		if (equipFull) {
			...
			final EquipableMisc[] miscs = new EquipableMisc[3];
			...
			GameScene.show(
					new WndOptions(new ItemSprite(this),
							Messages.get(EquipableMisc.class, "unequip_title"),
							Messages.get(EquipableMisc.class, "unequip_message"),
						...
						protected void onSelect(int index) {
							...
							EquipableMisc equipped = miscs[index];
							...
							int slot = Dungeon.quickslot.getSlot(EquipableMisc.this);
							slotOfUnequipped = -1;
							Dungeon.hero.belongings.backpack.items.remove(EquipableMisc.this);
							if (equipped.doUnequip(hero, true, false)) {
								//swap out equip in misc slot if needed
								if (index == 0 && EquipableMisc.this instanceof Ring){
									hero.belongings.artifact = (Artifact)hero.belongings.misc;
									hero.belongings.misc = null;
								} else if (index == 2 && EquipableMisc.this instanceof Artifact){
									hero.belongings.ring = (Ring) hero.belongings.misc;
									hero.belongings.misc = null;
								}
								Dungeon.hero.belongings.backpack.items.add(EquipableMisc.this);
								doEquip(hero);
							} else {
								Dungeon.hero.belongings.backpack.items.add(EquipableMisc.this);
							}
							if (slot != -1) {
								Dungeon.quickslot.setSlot(slot, EquipableMisc.this);
							} else if (slotOfUnequipped != -1 && defaultAction() != null){
								Dungeon.quickslot.setSlot(slotOfUnequipped, EquipableMisc.this);
							}
							updateQuickslot();
						}
