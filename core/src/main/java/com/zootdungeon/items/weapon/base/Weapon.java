...
import com.zootdungeon.actors.hero.spells.BodyForm;
...
import com.zootdungeon.items.weapon.curses.Displacing;
import com.zootdungeon.items.weapon.curses.Explosive;
import com.zootdungeon.items.weapon.curses.Friendly;
import com.zootdungeon.items.weapon.curses.Polarized;
...
import com.zootdungeon.items.weapon.enchantments.Blocking;
import com.zootdungeon.items.weapon.enchantments.Blooming;
import com.zootdungeon.items.weapon.enchantments.Chilling;
import com.zootdungeon.items.weapon.enchantments.Corrupting;
...
import com.zootdungeon.items.weapon.enchantments.Projecting;
import com.zootdungeon.items.weapon.enchantments.Shocking;
import com.zootdungeon.items.weapon.enchantments.Unstable;
import com.zootdungeon.items.weapon.enchantments.Vampiric;
import com.zootdungeon.items.weapon.base.MeleeWeapon;
import com.zootdungeon.items.weapon.RunicBlade;
...
abstract public class Weapon extends KindOfWeapon {
    ...
    public void onTargetDied(Hero attacker, Char target, int damage) {
        
    }

    // public void onTargetDied(Hero attacker, Char target, int damage, Object cause) {
    //     onTargetDied(attacker, target, damage, cause);
    // }

    // public void onTargetDied(Char attacker, Char target, int damage, Object cause) {
    // }
}
