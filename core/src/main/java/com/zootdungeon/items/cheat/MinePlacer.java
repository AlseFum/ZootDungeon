...
public class MinePlacer extends Item {
    ...
    public static final String AC_PLACE_DOOR = "PLACE_DOOR";
    public static final String AC_PLACE_REMOTE = "PLACE_REMOTE";
    public static final String AC_DETONATE_REMOTE = "DETONATE_REMOTE";
    static{
        TextureRegistry.texture("sheet.cola.trapist", "cola/trapist.png").setArea("trapist_icon", 0, 0, 64,64);
    }
    {
        image = TextureRegistry.idByLabel("trapist_icon");icon=ItemSpriteSheet.Icons.SYMBOL_DEBUG;
        stackable = false;
        unique = true;
    ...
    public void execute(Hero hero, String action) {
        ...
        } else if (action.equals(AC_PLACE_DOOR)) {
            GameScene.selectCell(placeDoor);
    ...
    public String actionName(String action, Hero hero) {
        ...
        if (action.equals(AC_PLACE_DOOR)) {
            return Messages.get(this, "ac_place_door");
        }
