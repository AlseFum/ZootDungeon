...
public class InventoryPane extends Component {
	...
	public void updateInventory(){
		...
		boolean hasTerminal = RhodesIslandTerminal.ownedBy(Dungeon.hero) != null;
		if (hasTerminal) {
			costTxt.text(Integer.toString(RhodesIslandTerminal.costOrZero(Dungeon.hero)));
			costTxt.measure();
		}
		costTxt.visible = cost.visible = hasTerminal;
		} else {
