...
public class WndAceCombo extends Window {

	private static final int WIDTH_P = 120;
	private static final int WIDTH_L = 180;
	private static final int MARGIN  = 2;

	public WndAceCombo(AceCombo combo) {
		super();
		...
		for (AceCombo.AceComboMove move : AceCombo.AceComboMove.values()) {
			String text = "_" + Messages.titleCase(move.moveName()) + " "
					+ Messages.get(this, "combo_req", move.comboReq) + ":_ " + move.moveDesc();
