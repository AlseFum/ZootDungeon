			...
			public void run () {
				if (CDSettings.fullscreen()){
					...
					if (!first){
						...
						monitorNum = CDSettings.fulLScreenMonitor();
					}
					...
					CDSettings.fulLScreenMonitor(monitorNum);
				} else {
					Point p = CDSettings.windowResolution();
