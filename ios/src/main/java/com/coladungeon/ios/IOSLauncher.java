...
public class IOSLauncher extends IOSApplication.Delegate {
	...
	protected IOSApplication createApplication() {
		...
		//this is mostly a copy-paste from IOSApplication.getPreferences
			...
			File finalPath = new File(libraryPath, CDSettings.DEFAULT_PREFS_FILE + ".plist");
			...
			CDSettings.set(new IOSPreferences(nsDictionary, finalPath.getAbsolutePath()));
		//end of prefs setup
		...
		config.hideHomeIndicator = CDSettings.fullscreen();
		config.overrideRingerSwitch = CDSettings.ignoreSilentMode();
		...
		return new IOSApplication(new ColaDungeon(new IOSPlatformSupport()), config);
	}
